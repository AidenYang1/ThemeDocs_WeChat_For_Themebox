...
# 该文档基于8.0.54建立，请等待补充修改调整。
如你的工作提前于大家，并愿意分享给大家，也欢迎你发起PR、反馈、私信联系我补充。
...
|     | 公众号     | add_friend_icon_offical       |                                         | 与通讯录页图标共用 |
...
|     | 收藏  | icons_outlined_colorful_favorites<br>icons_outlined_colorful_favorites_Dark |         |                 |
|     | 贴纸  | smile_regular                                                               |         |                 |
...
|     | 解释    |                                       图标命名                                        | 1x基本尺寸    | 说明  |
| :-- | :---- | :-------------------------------------------------------------------------------: | :-------- | :-- |
|     | 发送方发送 |            ChatRoom_Bubble_HB_Sender<br>ChatRoom_Bubble_HB_Sender_Dark            | 800 x 250 |     |
|     | 发送发接受 |    ChatRoom_Bubble_HB_Sender_Handled<br>ChatRoom_Bubble_HB_Sender_Handled_Dark    |           |     |
